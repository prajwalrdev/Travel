...
<section class="service-hero">
    <div class="container">
        <h1>City Taxi</h1>
        <p>Quick and reliable rides within the city</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="service-content">
            <div class="main-content">
                <h2>Affordable City Rides</h2>
                <p>Book city taxis for daily commutes, shopping, appointments, and more. Enjoy safe, comfortable, and on-time rides with our professional drivers and well-maintained vehicles.</p>
                <div class="features-grid">
                    <div class="feature-item">
                        <i class="fas fa-clock"></i>
                        <h3>24/7 Availability</h3>
                        <p>Book a ride any time, day or night.</p>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-map-marker-alt"></i>
                        <h3>Anywhere in the City</h3>
                        <p>We cover all major city areas and suburbs.</p>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-car"></i>
                        <h3>Clean & Safe Cars</h3>
                        <p>Regularly sanitized and inspected vehicles.</p>
                    </div>
                    <div class="feature-item">
                        <i class="fas fa-user-shield"></i>
                        <h3>Professional Drivers</h3>
                        <p>Experienced, courteous, and background-checked.</p>
                    </div>
                </div>
            </div>
            <div class="booking-sidebar">
                <h3>Book City Taxi</h3>
                <form class="booking-form" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <input type="hidden" name="service_name" value="City Taxi">
